		...
		<ul class="side-menu top">
			...
			<li class="active">
				...
				<i class='bx bxs-medal'></i>
					<span class="text">Points Settings</span>
				</a>
			</li>
		</ul>
		<ul class="side-menu">
			...
			<div class="head-title">
				<div class="left">
					...
					<ul class="breadcrumb1">
						...
						<li>
							<a class="active" href="#">List of Points</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="table-data">
				...
				<div class="container">
						...
						if(isset($_REQUEST['msg']) and $_REQUEST['msg']=="rds"){
							...
							echo	'<div id="toast-alert" class="alert alert-warning"><i class="fa fa-exclamation-triangle"></i> You did not change any thing!</div>';
