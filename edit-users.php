...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	if($update){
		header('location: browse-pupils.php?msg=rus');
		exit;
	}else{
		header('location: browse-pupils.php?msg=rnu');
		exit;
	}
}
?>
...
<body>
	...
	<div class="bg-light border-bottom shadow-sm sticky-top">
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add User</strong> <a href="browse-pupils.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse pupils</a></div>
			<div class="card-body">
