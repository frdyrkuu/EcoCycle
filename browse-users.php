...
<body>
	...
	$userData	=	$db->getAllRecords('pupils','*',$condition,'ORDER BY id DESC');
	?>
   	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse User</strong> <a href="add-pupils.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add pupils</a></div>
			<div class="card-body">
				<?php
			...
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						...
						<td align="center">
							<a href="edit-pupils.php?editId=<?php echo $val['id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a> | 
